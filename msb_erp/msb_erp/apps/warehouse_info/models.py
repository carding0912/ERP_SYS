...
from msb_erp.utils.base_model import BaseModel2, BaseModel


# Create your models here.

# 采购单入库 模型类
class PurchaseStorageModel(BaseModel2):
    ...
    status = models.CharField('状态,0:未审核,1:已审核,2:部分付款,3:付款完成', max_length=1, default='0')
